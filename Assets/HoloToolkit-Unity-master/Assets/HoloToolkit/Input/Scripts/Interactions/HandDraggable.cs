...
namespace HoloToolkit.Unity.InputModule
{
                                 ...
                                 ISourceStateHandler
    {
        ...
        private void Start()
        {
            ...
            gravity = GetComponent<CubeCommands>().graviy;
        ...
        {
            prevPos = HostTransform.position;
            ...
            HostTransform.GetComponent<Rigidbody>().MovePosition(draggingPosition + mainCamera.transform.TransformDirection(objRefGrabPoint));
            HostTransform.GetComponent<Rigidbody>().MoveRotation(HostTransform.rotation = draggingRotation);
